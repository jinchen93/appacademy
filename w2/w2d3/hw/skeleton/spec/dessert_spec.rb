...
describe Dessert do
  ...
  let(:dessert) { Dessert.new('brownie', 100, chef) }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ['chocolate', 'sugar', 'egg', 'icecream']
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Jin")
      expect(dessert.serve).to eq("Jin has made 100 brownies!")
    end
  end
